      ...
      <AuthCard title="Create your account">
        <form onSubmit={submit}>
          ...
          <div style={{ margin: '16px 0' }}>
            <button type="button" className="btn btn--oauth" onClick={() => window.location.href = import.meta.env.VITE_API_URL + '/auth/google'}>
              Sign up with Google
            </button>
            <button type="button" className="btn btn--oauth" onClick={() => window.location.href = import.meta.env.VITE_API_URL + '/auth/linkedin'}>
