...
export default function TemplateManager() {
  ...
  useEffect(() => {
    fetch(import.meta.env.VITE_API_URL + "/api/resume/templates")
      .then(res => res.json())
      .then(data => {
  ...
  function handleSaveCustomization() {
    fetch(import.meta.env.VITE_API_URL + `/api/resume/templates/${selectedTemplate.id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  function handleSetDefault(template) {
    fetch(import.meta.env.VITE_API_URL + `/api/resume/templates/${template.id}/default`, {
      method: "POST",
    })
  ...
  function handleShareTemplate(email) {
    fetch(import.meta.env.VITE_API_URL + `/api/resume/templates/${selectedTemplate.id}/share`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
