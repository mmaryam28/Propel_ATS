...
export default function QualityCheck() {
  ...
  const fetchResumes = async () => {
    try {
      const response = await axios.get(import.meta.env.VITE_API_URL + `/resume?userId=${userId}`, {
  ...
  const fetchCoverLetters = async () => {
    try {
      const response = await axios.get(import.meta.env.VITE_API_URL + `/coverletters?userId=${userId}`, {
        withCredentials: true
      });
  ...
  const fetchHistory = async () => {
    ...
    try {
      const response = await axios.get(import.meta.env.VITE_API_URL + `/application-quality/history/${userId}`, {
        params: jobId ? { jobId } : {},
      });
  ...
  const fetchStatistics = async () => {
    if (!userId) return;
    try {
      const response = await axios.get(import.meta.env.VITE_API_URL + `/application-quality/statistics/${userId}`);
  ...
  const handleResumeSelect = async (resumeId) => {
    ...
    try {
      const response = await axios.get(import.meta.env.VITE_API_URL + `/resume/${resumeId}`, {
        withCredentials: true
      });
  ...
  const handleCoverLetterSelect = async (coverLetterId) => {
    ...
    try {
      const response = await axios.get(import.meta.env.VITE_API_URL + `/coverletters/${coverLetterId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(import.meta.env.VITE_API_URL + '/application-quality/score', {
        userId,
